...
import com.eat_healthy.tiffin.utils.ProgressWheelV2;

public class ProgressHelperV2 {
    private ProgressWheelV2 mProgressWheel;
    ...
    public ProgressHelperV2(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
    ...
    public ProgressWheelV2 getProgressWheel () {
        return mProgressWheel;
    }

    public void setProgressWheel (ProgressWheelV2 progressWheel) {

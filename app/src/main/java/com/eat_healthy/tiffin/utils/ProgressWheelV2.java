...
public class ProgressWheelV2 extends View {
    private static final String TAG = ProgressWheelV2.class.getSimpleName();
     ...
     * @param attrs
     */
    public ProgressWheelV2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                R.styleable.ProgressWheel));
     ...
     * @param context
     */
    public ProgressWheelV2(Context context) {
        super(context);
    }
...
//    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ProgressWheelV2.WheelSavedState ss = new ProgressWheelV2.WheelSavedState(superState);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if(!(state instanceof ProgressWheelV2.WheelSavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        ProgressWheelV2.WheelSavedState ss = (ProgressWheelV2.WheelSavedState)state;
    ...
    static class WheelSavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<ProgressWheelV2.WheelSavedState> CREATOR =
                new Parcelable.Creator<ProgressWheelV2.WheelSavedState>() {
                    public ProgressWheelV2.WheelSavedState createFromParcel(Parcel in) {
                        return new ProgressWheelV2.WheelSavedState(in);
                    }
                    public ProgressWheelV2.WheelSavedState[] newArray(int size) {
                        return new ProgressWheelV2.WheelSavedState[size];
                    }
                };
    }
}
